...
export default function RoomActionsGrid({ id, quick, deep }: Props) {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-px bg-line-inv">
          ...
          <div className="bg-dark-2 p-8 lg:p-10">
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-sm text-ink-dim">Gratuit ou faible coût</span>
            </div>

            <div className="flex flex-col gap-7">
              {quick.map((action, i) => (
                <div key={i} className="flex flex-col gap-1.5 border-l-2 border-line-inv pl-4">
          ...
          {/* Colonne droite : actions de fond */}
          <div className="bg-dark p-8 lg:p-10">
            <div className="flex items-center gap-3 mb-8">
              ...
              <span className="text-sm text-ink-dim">Investissement ou changement structurel</span>
            </div>
