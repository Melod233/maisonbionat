    ...
    groups: [
      {
        ...
        topics: [
          ...
          { label: "Amiante dans le logement",     href: "/materiaux-sains/amiante-logement/" },
          { label: "Plomb des peintures anciennes",href: "/materiaux-sains/plomb-peintures-anciennes-crep/" },
        ],
      },
      {
        id: "renovation-saine",
        ...
        topics: [
          ...
          { label: "MaPrimeRénov' et choix sains", href: "/renovation-saine/maprimerenov-choix-sains/" },
          { label: "Acheter maison ancienne",   href: "/renovation-saine/acheter-maison-ancienne-saine/" },
        ],
      },
    ],
  },
    ...
    groups: [
      {
        ...
        topics: [
          ...
          { label: "Vaisselle et ustensiles",        href: "/produits-et-habitudes/vaisselle-ustensiles-sains/" },
          { label: "Plastiques alimentaires",        href: "/produits-et-habitudes/plastiques-alimentaires-sains/" },
        ],
      },
      {
        ...
        topics: [
          ...
          { label: "Matelas et literie sains",  href: "/maison-saine-famille/matelas-literie-sains/" },
          { label: "Déménagement et logement sain", href: "/maison-saine-famille/demenagement-logement-sain/" },
        ],
      },
    ],
  },
    ...
    groups: [
      {
        ...
        topics: [
          ...
          { label: "Légionelles eau chaude",      href: "/eau-maison/legionelles-eau-chaude-sanitaire/" },
          { label: "Adoucisseur d'eau",           href: "/eau-maison/adoucisseur-eau-sante/" },
        ],
      },
      {
        id: "chauffage-sain",
        ...
        topics: [
          ...
          { label: "Insert vs poêle à bois",          href: "/chauffage-sain/insert-cheminee-vs-poele-bois/" },
          { label: "Climatisation et qualité d'air",  href: "/chauffage-sain/climatisation-qualite-air/" },
        ],
      },
      {
        id: "jardin",
        ...
        siloHref: "/jardin/",
        topics: [
          { label: "Sol vivant et paillage",              href: "/jardin/sol-vivant-paillage-matiere-organique/" },
          { label: "Récupération d'eau de pluie",         href: "/jardin/recuperation-eau-pluie-arrosage/" },
          { label: "Compostage des biodéchets",           href: "/jardin/compostage-biodechets-jardin/" },
          { label: "Pesticides : alternatives concrètes", href: "/jardin/pesticides-jardin-alternatives/" },
          { label: "Mobilier de jardin durable",          href: "/jardin/mobilier-jardin-bois-durable/" },
          { label: "Analyse de sol potager",              href: "/jardin/analyse-sol-potager-metaux-lourds/" },
          { label: "Pelouse saine et tonte raisonnée",    href: "/jardin/pelouse-saine-tonte-raisonnee/" },
          { label: "Pollens et jardin allergique",        href: "/jardin/pollens-jardin-allergique/" },
        ],
      },
    ],
  },
